      ...
      <div class="user-wrapper">
         <div>
            ...
            <div class="dropdown open">
               ...
               <a class="dropdown-item" type="button" href="#"><span class="las la-user border-0 rounded-0"></span> Profile</a>
                  <a class="dropdown-item" type="button" href="#"><span class="las la-users border-0 rounded-0"></span> Add Users</a>
