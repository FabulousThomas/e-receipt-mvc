...
<body>
   ...
   <div class="row">
      <div class="col-lg-5 col-md-12 mx-auto p-0">
         ...
         <div class="form-group">
            <input type="email" name="email" class="form-control form-control-lg <?php echo (empty($data['email'])) ? 'is-invalid' : ''; ?>" placeholder="EMAIL" value="<?php echo $data['email']; ?>" spellcheck="false" autocomplete="off">
         ...
         <div class="row">
            <div class="col">
            <button type="submit" name="login_btn" class="btn btn-primary form-control-lg rounded-0 btn-block" id="submit">Register</button>
            </div>
            <div class="col">
           <a href="<?php echo URLROOT;?>/users/login" class="btn btn-light form-control-lg rounded-0" style="font-size: .9rem ;">Have an account? Login</a>
            </div>
         </div>
         <!-- <div class="form-group">
            <?php if ($loginErr) { ?>
